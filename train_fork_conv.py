...
SCRATCHFOLDER="results/retrainedforkdata"
                  ...
                  for decoding_spatial_derivative_regularization in [0.0]:
                    for decoding_l2_weight_decay in [0.0]:
                      ...
                      for emb_dropout in [0]:
                        for paramdict in [bc.convup_no_dtw]: 
                            ...
                            for dec_side_hiddens in [[200]]: 
                              ...
                              for emb_conv_fc_size in [0]:
                                ...
                                if paramdict["decoder_name"] == "convolutional_decoder_upsampling":
                                  paramdict["dec_gen_conv_layers_channels"] = [20,20,7]
